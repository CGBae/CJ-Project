                ...
                <fieldset className="p-6 border border-gray-200 rounded-lg shadow-sm">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <button type="button" onClick={() => setMood('energetic')} className={getButtonClass(mood === 'energetic')}>활기차게</button>
                    ...
                    <div className="mb-6">
                        ...
                        <select id="instrument" name="instrument" value={instrument} onChange={handleChange} 
                            ...
                            {['Drums', 'Bass', 'Synth Pad', 'Electric Guitar'].map((inst) => (
                                <label key={inst} className="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" 
                                        checked={excludedInstruments.includes(inst)} onChange={() => handleExcludeToggle(inst)} />
