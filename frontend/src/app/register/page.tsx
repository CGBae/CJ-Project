            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-2xl">
                ...
                <div className="flex rounded-md shadow-sm">
                    <button
                        ...
                        className={`flex-1 py-3 px-4 text-sm font-medium rounded-l-lg border ${role === 'patient' ? 'bg-indigo-600 text-white border-indigo-600 z-10' : 'bg-white text-gray-700 hover:bg-gray-50'
                            }`}
                        disabled={loading}
                    >
                        환자로 가입
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 px-4 text-sm font-medium rounded-r-lg border -ml-px ${role === 'therapist' ? 'bg-indigo-600 text-white border-indigo-600 z-10' : 'bg-white text-gray-700 hover:bg-gray-50'
                            }`}
                        disabled={loading}
                    >
                        상담사로 가입
